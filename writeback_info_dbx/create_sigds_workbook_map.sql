...
CREATE TABLE IF NOT EXISTS SIGDS_WORKBOOK_MAP (
  ...
  SCAN_SCHEMA        STRING    COMMENT 'Schema where the WAL and SIGDS tables reside; part of the composite merge key (SIGDS_TABLE + SCAN_SCHEMA). Allows multiple writeback schemas to share one SIGDS_WORKBOOK_MAP table.',
