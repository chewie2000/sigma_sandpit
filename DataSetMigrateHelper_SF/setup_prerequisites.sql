...
--
--    sigma_base_url    — the API base URL for your cloud/region (see host table
--                        above). Stored as a secret so it is defined in one place
--                        and stays in sync with the network rule automatically.
